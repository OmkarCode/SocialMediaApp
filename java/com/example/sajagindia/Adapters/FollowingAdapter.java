package com.example.sajagindia.Adapters;//package com.example.sajagindia
...
import com.example.sajagindia.search.visit_another_profile.VisitOtherUserProfileScreen;
...
public class FollowingAdapter extends RecyclerView.Adapter<FollowingAdapter.ViewAdapter> {
    ...
    public FollowingAdapter(Context context, List<String> pipDate) {
